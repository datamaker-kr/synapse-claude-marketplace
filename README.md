...
| `/synapse-plugin-helper:add-changelog` | GitHub Release body에 Changelog 생성 |
...
| **plugin-changelog** | "changelog", "릴리스 노트", "Keep a Changelog", "Release body" |
...
| *(신규)* | `/synapse-plugin-helper:add-changelog` |
