...
│   └── ask the user a concise clarification → Resolve ambiguities in spec
├── Phase 3: Planning
...
- Use ask the user a concise clarification: "What feature would you like to build? Describe it in 1-3 sentences."
...
3. Generate up to 5 targeted clarification questions using ask the user a concise clarification.
