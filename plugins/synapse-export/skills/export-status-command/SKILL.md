---
name: export-status-command
description: "Run the `synapse-export:export-status` workflow from the original Claude slash command. Use when the user asks to check status and logs of a Synapse export job"
---
