---
name: help-command
description: "Run the `synapse-export:help` workflow from the original Claude slash command. Use when the user asks to show all available Synapse export commands and features"
---
