---
name: sync-jira-tickets-command
description: "Run the `platform-dev-team-common:sync-jira-tickets` workflow from the original Claude slash command. Use when the user asks to 현재 프로젝트의 CHANGELOG.md에 있는 Jira 티켓들을 Git 브랜치 상태에 맞게 동기화합니다."
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# platform-dev-team-common:sync-jira-tickets Command Workflow
