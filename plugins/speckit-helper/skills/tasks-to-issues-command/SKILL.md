---
name: tasks-to-issues-command
description: "Run the `speckit-helper:tasks-to-issues` workflow from the original Claude slash command. Use when the user asks to convert tasks from tasks.md into GitHub Issues with labels and dependencies"
---
...
- If `--dry-run` is present anywhere in `the user request or explicit arguments`, enable dry-run mode.
