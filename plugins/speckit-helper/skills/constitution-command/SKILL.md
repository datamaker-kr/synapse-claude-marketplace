...
description: "Run the `speckit-helper:constitution` workflow from the original Claude slash command. Use when the user asks to create or update project constitution defining principles and governance rules"
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# speckit-helper:constitution Command Workflow
...
#### 2b. Gather Principles via ask the user a concise clarification

Collect principles in four categories, using ask the user a concise clarification for each:
...
Use **ask the user a concise clarification** to ask:
