---
name: help-command
description: "Run the `speckit-helper:help` workflow from the original Claude slash command. Use when the user asks to show all available Speckit Helper commands, workflow, and quick-start guide"
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# speckit-helper:help Command Workflow
