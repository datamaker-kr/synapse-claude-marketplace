---
name: tasks-command
description: "Run the `speckit-helper:tasks` workflow from the original Claude slash command. Use when the user asks to decompose specifications and plans into executable, dependency-ordered tasks"
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# speckit-helper:tasks Command Workflow
