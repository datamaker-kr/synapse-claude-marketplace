---
name: help-command
description: "Run the `synapse-upload:help` workflow from the original Claude slash command. Use when the user asks to show all available Synapse upload commands and features"
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# synapse-upload:help Command Workflow
