---
name: upload-status-command
description: "Run the `synapse-upload:upload-status` workflow from the original Claude slash command. Use when the user asks to check status and logs of a Synapse upload job"
---
