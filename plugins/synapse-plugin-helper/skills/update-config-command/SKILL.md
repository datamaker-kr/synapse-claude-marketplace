...
description: "Run the `synapse-plugin-helper:update-config` workflow from the original Claude slash command. Use when the user asks to sync action metadata from code into config.yaml"
---
