---
name: create-command
description: "Run the `synapse-plugin-helper:create` workflow from the original Claude slash command. Use when the user asks to create a new Synapse plugin with guided setup"
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# synapse-plugin-helper:create Command Workflow
