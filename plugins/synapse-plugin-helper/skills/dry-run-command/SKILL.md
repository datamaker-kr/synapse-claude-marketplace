...
description: "Run the `synapse-plugin-helper:dry-run` workflow from the original Claude slash command. Use when the user asks to validate Synapse plugin before deployment"
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# synapse-plugin-helper:dry-run Command Workflow
