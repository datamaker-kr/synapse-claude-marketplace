---
name: help-command
description: "Run the `synapse-plugin-helper:help` workflow from the original Claude slash command. Use when the user asks to show all available Synapse plugin development commands and features"
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# synapse-plugin-helper:help Command Workflow
...
Welcome to the Synapse Plugin Development toolkit for the active coding agent.
