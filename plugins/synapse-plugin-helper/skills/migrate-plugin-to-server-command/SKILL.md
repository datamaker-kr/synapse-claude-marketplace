---
name: migrate-plugin-to-server-command
description: "Run the `synapse-plugin-helper:migrate-plugin-to-server` workflow from the original Claude slash command. Use when the user asks to migrate plugins and their latest releases from one Synapse server to another"
---

<!-- Generated by tools/generate-agent-marketplaces.py; edit the source command or agent-plugin.yaml instead. -->

# synapse-plugin-helper:migrate-plugin-to-server Command Workflow
